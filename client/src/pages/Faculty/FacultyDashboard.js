...
import FacultyMenu from "../../components/Layout/FacultyMenu"; // Changed from AdminMenu to FacultyMenu
import { useAuth } from "../../context/auth";
import { toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import axios from "axios";
import { Phone, Mail, User, Activity, UserCheck, Trash2, Building2, GraduationCap } from "lucide-react";
            ...
            <div className="welcome-card">
              <div className="welcome-header">
                ...
                <div className="welcome-content">
                  <h1>Faculty Administration Portal</h1>
            ...
            <div className="members-section">
              <div className="section-header">
                <div className="header-content">
                  ...
                  <div>
                    <h2>Department Membership Requests</h2>
